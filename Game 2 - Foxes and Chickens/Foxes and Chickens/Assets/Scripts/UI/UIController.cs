...
/// </summary>
public class UIController : GameMenu
{
    //UI Objects
    [SerializeField]
    private GameObject gameRunningUI, gamePausedUI, levelFailedUI, levelCompleteUI;

    private GameObject activeUI;

    /// <summary>
    /// Show a specific UI Object
    /// </summary>
    ...
    /// <summary>
    /// Show the level failed UI (and hide all others)
    /// </summary>
    private void ShowLevelFailedUI()
    {
        ShowUI(levelFailedUI);
    }
    ...
    private void OnEnable()
    {
        ...
        GameStateManager.LevelFailed += ShowLevelFailedUI;
