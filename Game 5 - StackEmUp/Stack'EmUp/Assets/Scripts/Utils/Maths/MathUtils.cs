...
namespace Lewis.MathUtils
{
    ...
    public static class MathUtils
    {
        ...
        /// <returns></returns>
        public static Vector2 ClampVec2(Vector2 value, Vector2 min, Vector2 max)
        {
        ...
        /// <summary>
        /// Gets a vector 3 between a range of a min and max vector 3
        /// </summary>
        /// <returns>Vector 3 with values between the range of the min and max vector</returns>
        public static Vector3 RangeVec3(Vector3 minVec, Vector3 maxVec)
        {
